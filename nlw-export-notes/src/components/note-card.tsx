  ...
  return (
    <button className="rounded-md bg-slate-800 p-5 space-y-3 overflow-hidden relative outline-none hover:ring-2 hover:ring-slate-600 focus-visible:ring-2 focus-visible:ring-lime-400">
      ...
      <p className="text-sm leading-6 text-slate-400">
        ...
        quisquam accusantium omnis praesentium corrupti accusamus, tempore ex
        repudiandae magni facilis quia culpa a quibusdam ducimus doloremque
        animi dolorum! Veritatis, repellendus?
      </p>
